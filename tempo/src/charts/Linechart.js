...
//                 return itemDate === formatteddate;
//               }
//               return false; // Filter out items with missing or undefined 'dt' property
//             });
//           });
//           grapTotlaRes.current = filteredData;
...
//               }
//               getChartData1(globalfilter, finalValue[obj_key], i);
//               console.log("getChartData1 : ", getChartData1);
//             }
//           } else {
//             getChartData1(globalfilter, filteredData[mac_to_conform], i);
//           }
...
//               const latestSixData = finalValue[obj_key].slice(-6);
//               getChartData1(selectedOption2Ref.current[i], latestSixData, i);
//               console.log(" initial getChartData1 : ", getChartData1);
//             }
//           }
//           else {
//             console.log("key : ",filteredData,mac_to_conform);
//             const latestSixData = data1[mac_to_conform]; //.slice(-6)
//             // console.log(message,mac_to_conform);
//             console.log("test :",latestSixData);
//             if (latestSixData === undefined) {
//               continue
//             } else {
//               getChartData1(selectedOption2Ref.current[0], latestSixData, i);
//             }
//           }
//         }
//       }
...
//   //set the graph state to draw graph using setuserdata
//   const getChartData1 = (selectedOption2, latestData, index) => {
//     // console.log("test : ", selectedOption2, latestData, index);
//     // console.log(latestData);
//     setUserData1(prevState => {
//       // console.log("hai : ",latestData);
//       const updatedData = [...prevState];
//       if (selectedOption2 != "ALL") {
//         console.log("kk");
//         updatedData[index] = {
